...
export const DEFAULT_DATA: MenuData = {
  ...
  brand: {
    restaurantName: "مطعم النجوم الذهبية",
    restaurantNameEn: "Al Njoum Althahabiya",
    tagline: "",
    taglineEn: "",
    logo: "",
    accent: "#f59e0b",
  ...
  contact: {
    ...
    phone: "037622300",
    address: "",
    mapUrl: "https://maps.app.goo.gl/r25sdhV5Vr3Cng6a7",
    instagram: "",
    facebook: "",
